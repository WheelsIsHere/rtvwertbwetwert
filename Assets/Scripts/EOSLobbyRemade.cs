...
public class EOSLobbyRemade : MonoBehaviour {
    ///<returns>True if the user is connected to a lobby.</returns>
    public TMP_InputField CodeField;
    public static EOSLobbyRemade instance;
    ...
    {
        JoinLobbyByID(CodeField.text);
    }
    public void CreateLobby2()
    {
        CreateLobby(2, LobbyPermissionLevel.Publicadvertised, true, null);
    }
